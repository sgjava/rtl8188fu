...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6,0,0))
static int cfg80211_rtw_add_key(struct wiphy *wiphy, struct net_device *ndev, int val,
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6,0,0))
static int cfg80211_rtw_get_key(struct wiphy *wiphy, struct net_device *ndev, int val,
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6,0,0))
static int cfg80211_rtw_del_key(struct wiphy *wiphy, struct net_device *ndev, int val,
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6,0,0))
	struct net_device *ndev, int val, u8 key_index
#else
